...
public class GetAllShould {
    @Mock private EmployeesRepository repository;
    @Mock private GetAllEmployeesOutput output;
    @InjectMocks private GetAllEmployees interactor;

    @Test
    public void returnAllEmployees() {
        List<Employee> employees = Arrays.asList(new Employee(1, "Darth Vader"), new Employee(2, "Luke Skywalker"));
